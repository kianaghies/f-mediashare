	...
	<div class="navbar-custom-menu">
		<ul class="nav navbar-nav">
			...
			<li class="dropdown user user-menu">
                ...
                <img src="<?= base_url('assets/uploads/images/foto_profil/'.$userdata->profile); ?>" class="user-image">
                <span class="hidden-xs"><?= $userdata->nama; ?> </span>
            </a>
				<ul class="dropdown-menu">
					<!-- User image -->
					<li class="user-header">
						<img src="<?= base_url('assets/uploads/images/foto_profil/'.$userdata->profile); ?>" class="img-circle">
						<p>
							<?= $userdata->email; ?>
